...
public class ImportJsonTest {
    ...
    public void shouldImportAllJsonWithPropertyMappings() throws Exception {
        ...
        try(Transaction tx = db.beginTx()) {
            ...
            assertTrue(props.get("place") instanceof PointValue);
            ...
            assertTrue(props.get("born") instanceof LocalDateTime);

            Relationship rel = tx.execute("MATCH ()-[r:KNOWS]->() RETURN r")
                    .<Relationship>columnAs("r")
                    .next();
            assertTrue(rel.getProperty("bffSince") instanceof DurationValue);
