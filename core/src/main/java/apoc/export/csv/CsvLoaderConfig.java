...
public class CsvLoaderConfig extends CompressionConfig {
    ...
    private final boolean ignoreArrayEmptyCell;
    ...
    private CsvLoaderConfig(Builder builder) {
        ...
        this.ignoreArrayEmptyCell = builder.ignoreArrayEmptyCell;
    }
    ...
    public boolean isIgnoreArrayEmptyCell() {
        return ignoreArrayEmptyCell;
    }
    ...
    public static CsvLoaderConfig from(Map<String, Object> config) {
        ...
        if (config.get(IGNORE_EMPTY_CELL_ARRAY) != null) builder.ignoreArrayEmptyCell((boolean) config.get(IGNORE_EMPTY_CELL_ARRAY));
    ...
    public static final class Builder {
        ...
        private boolean ignoreArrayEmptyCell = IGNORE_EMPTY_CELL_ARRAY_DEFAULT;
        ...
        public Builder ignoreArrayEmptyCell(boolean ignoreArrayEmptyCell) {
            this.ignoreArrayEmptyCell = ignoreArrayEmptyCell;
            return this;
        }
