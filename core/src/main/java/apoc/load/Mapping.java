...
public class Mapping extends AbstractMapping {
    ...
    public Mapping(String name, Map<String, Object> mapping, char arraySep, boolean ignore, Supplier<ZoneId> zoneId) {
        ...
        if (this.zoneId == null) {
            System.out.println("DB_TEMPORAL_TIMEZONE" + DB_TEMPORAL_TIMEZONE);
            System.out.println("DB_TEMPORAL_TIMEZONE" + apocConfig().getString("db.temporal.timezone"));
            System.out.println("config here1" +  apocConfig().getString("1db.temporal.timezone"));
