...
//        try {
//            System.out.println("(String) optionalData.getOrDefault(timezone apocConfig().getString(db_temporal_timezone.name())) " + (String) optionalData.getOrDefault("timezone", apocConfig().getString(db_temporal_timezone.name())));
//        } catch (NullPointerException e) {
//            System.out.println("Mapping.convertType");
//        }
//        System.out.println("getTimezoneIfValid(optionalData, DB_TEMPORAL_TIMEZONE) " + getTimezoneIfValid(optionalData, DB_TEMPORAL_TIMEZONE));
