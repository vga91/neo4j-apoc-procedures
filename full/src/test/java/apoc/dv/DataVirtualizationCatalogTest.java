...
//        testVirtualizeCSVCommon();
//        try (final Transaction tx = ApocConfig.apocConfig().getSystemDb().beginTx()) {
//            final Iterator<Node> nodes = nodeIterator(tx);
//            nodeAssertions(nodes.next(), "csv_vr", "aaa");
...
//    }
//
//    private void testVirtualizeCSVCommon() {
...
//        testVirtualizeJDBCWithParameterMapCommon();
//
//        try (final Transaction tx = ApocConfig.apocConfig().getSystemDb().beginTx()) {
//            final Iterator<Node> nodes = nodeIterator(tx);
//            nodeAssertions(nodes.next(), "jdbc_vr", "aaa");
//            assertFalse(nodes.hasNext());
//        }
//
//        testVirtualizeJDBCWithParameterMapCommon();
//
//        // todo - pure qua che ci sono i parametru...
//    }
//
//    private void testVirtualizeJDBCWithParameterMapCommon() {
//        String name = "jdbc_vr";
//        String desc = "country details";
//        List<Label> labels = List.of(Label.label("Country"));
//        List<String> labelsAsString = List.of("Country");
