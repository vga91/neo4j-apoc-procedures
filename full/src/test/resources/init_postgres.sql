...
CREATE TABLE PERSON (
    ...
    "TEST_TIME" TIME,
    "NULL_DATE" DATE,
    "SMALL_NUM" numeric(30),
    "BIG_NUM" numeric(30, 1),
    "UUID" UUID
    );

INSERT INTO PERSON ("NAME", "SURNAME", "HIRE_DATE", "EFFECTIVE_FROM_DATE", "TEST_TIME", "NULL_DATE", "SMALL_NUM", "BIG_NUM", "UUID")
VALUES ('John', null, '2017-05-25', '2016-06-22 19:10:25+02', '15:37', null, 12345, 10223372036854776000.0, gen_random_uuid());