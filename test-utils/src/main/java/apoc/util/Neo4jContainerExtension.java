 ...
 */
public class Neo4jContainerExtension implements AutoCloseable /*extends Neo4jContainer<Neo4jContainerExtension> */{
...
//        super.start();
        if (withDriver) {
            driver = GraphDatabase.driver("bolt://" + getHost() + ":7687", getAuth());
