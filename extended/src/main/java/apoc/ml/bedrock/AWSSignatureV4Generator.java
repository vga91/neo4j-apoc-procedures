...
// todo - oppure con questo: https://docs.aws.amazon.com/vpc-lattice/latest/ug/sigv4-authenticated-requests.html#sigv4-authenticated-requests-java-with-interceptor

// todo - oppure questo? https://github.com/thinhle-agilityio/aws-v4/blob/master/index.js


// todo - try this without builder??
/**
 * Sign AWS Requests with Signature Version 4 Signing Process.
 */

// todo - maybe call it Interceptor??
public class AWSSignatureV4Generator {
    ...
    private Map<String, Object> awsHeaders;
    ...
    private AWSSignatureV4Generator(Builder builder) {
        ...
        awsHeaders = new HashMap<>(builder.awsHeaders);
    ...
    private String prepareCanonicalRequest() throws Exception {
        ...
        canonicalURL.append(addCanonicalQueryString(canonicalURL));

        // Step 1.4 Add the canonical headers, followed by a newline character.
        StringBuilder signedHeaders = new StringBuilder("");
        
        awsHeaders.forEach((key,value) -> {
            signedHeaders.append(key).append(";");
            canonicalURL.append(key)
                    .append(":")
                    .append(value)
                    .append("\n");
        });
...
//        }
     ...
     * @return Headers.
     */
    public Map<String, Object> getHeaders() throws Exception {
...
//        header.put("x-amz-date", xAmzDate);
        awsHeaders.put("Authorization", buildAuthorizationString(signature));
...
//        System.out.println("================================");
    ...
    public static class Builder {
        ...
        public Builder awsHeaders(Map<String, Object> awsHeaders) {
