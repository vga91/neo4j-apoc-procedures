...
import static apoc.util.Util.HTTP_TIMEOUT_CONNECT_CONFIG;
import static apoc.util.Util.HTTP_TIMEOUT_READ_CONF;
...
public class Config {
    private static final Set<String> WHITELIST_CONFIGS = Set.of(
            ...
            // apoc.http.
            HTTP_TIMEOUT_CONNECT_CONFIG,
            HTTP_TIMEOUT_READ_CONF,
