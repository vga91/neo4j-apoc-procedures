...
|apoc.ml.bedrock.embedding(body, $config)| To create an API call to generate embedding
|apoc.ml.bedrock.chat(body, $config)| To create a Chat Completion API call
|apoc.ml.bedrock.completion(body, $config)| To create a Text Completion API call
