...
[source,cypher]
----
CALL apoc.vectordb.qdrant.get('localhot:6333', 'test_collection', [1,2], {<optional config>})
----
...
[source,cypher]
----
CALL apoc.vectordb.chroma.get('localhot:8000', '<collection_id>', [1,2], {<optional config>})
----
