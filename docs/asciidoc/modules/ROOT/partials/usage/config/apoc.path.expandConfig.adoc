...
| nodePropFilter | String | null | To specify a property filter for any nodes. See <<prop-filter>.
| relPropFilter | String | null | To specify a property filter for any relationships. See <<prop-filter>.
|===
...
include::partial$property-filter.adoc[]