...
| includeDirections | boolean | false | If true, append to relationship type list, a suffix " >" or " <" if the relation is respectively outgoing or incoming from parent node.
|===